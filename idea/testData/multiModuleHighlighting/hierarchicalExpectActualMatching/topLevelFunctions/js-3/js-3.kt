...
actual <!NOTHING_TO_INLINE("public actual inline fun <T> T.case_11(): I defined in sample in file js-3.kt")!>inline<!> fun <T> T.case_11() = object : I {}

class Case9 : I {}

actual fun <!ACTUAL_WITHOUT_EXPECT("Actual function 'case_12'", " The following declaration is incompatible because return type is different:     public expect fun case_12(): I ")!>case_12<!>() = Case9()

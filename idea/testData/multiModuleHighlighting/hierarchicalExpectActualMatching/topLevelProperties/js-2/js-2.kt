...
actual <!ACTUAL_WITHOUT_EXPECT("Actual property 'case_9'", " The following declaration is incompatible because property kinds are different (val vs var):     public expect val <T> T.case_9: T ")!>var<!> <T> T.case_9
    get() = null <!UNCHECKED_CAST("Nothing?", "T")!>as T<!>
    set(<!UNUSED_PARAMETER("value")!>value<!>) {}

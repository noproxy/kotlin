...
/**
 * A source of time, that can be used to measure time intervals.
 *
...
public interface ClockMark {
    ...
    /**
     * Returns a clock mark on the same clock that stands behind this clock mark by the specified [duration].
     *
